...
extern "C"
{
  ...
  void flox_simulated_executor_set_bracket_child_arm_mode(FloxSimulatedExecutorHandle executor,
                                                          uint8_t mode);
  void flox_simulated_executor_submit_iceberg(FloxSimulatedExecutorHandle executor, uint64_t id,
                                              uint8_t side, double price, double total_quantity,
                                              double visible_quantity, uint32_t symbol);
  void flox_simulated_executor_set_iceberg_refresh_latency(FloxSimulatedExecutorHandle executor,
                                                           int64_t latency_ns);
  ...
  void flox_venue_availability_schedule_outage(FloxVenueAvailabilityHandle h, int64_t start_ns,
                                               ...
                                               int64_t gtc_ttl_ns);
  void flox_venue_availability_schedule_outage_ex(FloxVenueAvailabilityHandle h, int64_t start_ns,
                                                  int64_t duration_ns, uint8_t outage_type,
                                                  uint8_t policy, int64_t gtc_ttl_ns,
                                                  double degradation_latency_multiplier,
