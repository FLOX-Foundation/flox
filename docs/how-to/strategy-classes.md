...
4.3 MB. One fits on a default 8 MB stack, two in the same function do not, and
the overflow lands in the constructor prologue before a single line of the
strategy has run. The bindings allocate for you.
