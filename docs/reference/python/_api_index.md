...
Surface: 77 classes, 56 functions, 17 constants.
...
- `DataRecorder(output_dir: str, exchange_name: str, max_segment_mb: typing.SupportsInt | typing.SupportsIndex = 256) -> None`
