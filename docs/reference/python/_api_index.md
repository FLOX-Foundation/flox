...
Surface: 85 classes, 56 functions, 30 constants.
...
- `BinaryLogRecorderHook(output_dir: str, max_segment_mb: typing.SupportsInt | typing.SupportsIndex = 256, exchange_id: typing.SupportsInt | typing.SupportsIndex = 0, compression: str = 'none') -> None`
