...
Surface: 118 classes, 79 functions, 41 constants.
...
- `capi_abi_version() -> int` — C ABI version the loaded flox library reports. Equal to
...
- `order_type_code(name: str) -> int` — Wire code of a canonical order-type name (flox::OrderType space).
- `order_type_name(code: typing.SupportsInt | typing.SupportsIndex) -> str` — Canonical name of an order-type wire code (flox::OrderType space).
...
- `set_log_callback(callback: typing.Any) -> None` — Install a Python callable as the global log sink. Pass None to detach. Callable receives (level: int, msg: str); level: 0=info, 1=warn, 2=error. The binding detaches it automatically at interpreter shutdown.
...
- `u256_from_hex(hex: str) -> int`
- `u256_roundtrip(value: int) -> int`
...
- `constant_product(reserve0: int, reserve1: int, fee_num: typing.SupportsInt | typing.SupportsIndex = 997, fee_den: typing.SupportsInt | typing.SupportsIndex = 1000) -> AmmCurve`
- `raydium_cp(reserve0: int, reserve1: int, trade_fee_rate: typing.SupportsInt | typing.SupportsIndex, creator_fee_rate: typing.SupportsInt | typing.SupportsIndex = 0, creator_fee_on_input: bool = True) -> AmmCurve`
- `uniswap_v3(sqrt_price_x96: int, liquidity: int, fee_pips: typing.SupportsInt | typing.SupportsIndex, ticks: list = []) -> AmmCurve`
- `amount_out(self, i: typing.SupportsInt | typing.SupportsIndex, j: typing.SupportsInt | typing.SupportsIndex, amount_in: int) -> int`
- `apply_swap(self, i: typing.SupportsInt | typing.SupportsIndex, j: typing.SupportsInt | typing.SupportsIndex, amount_in: int) -> int`
- `balances(self) -> list`
- `clone(self) -> AmmCurve`
- `liquidity(self) -> int | None`
- `sqrt_price(self) -> int | None`
...
- `BookSnapshotBinAggregator(bucket_ns: typing.SupportsInt | typing.SupportsIndex, levels: typing.SupportsInt | typing.SupportsIndex = 20, event_filter: AggregatorEventFilter = ..., symbol_filter: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex] = []) -> None`
...
- `curve(self) -> AmmCurve`
- `drift_count(self) -> int`
- `trade_count(self) -> int`
...
- `checkpoint(self, ts_ns: typing.SupportsInt | typing.SupportsIndex, reserve0: int, reserve1: int) -> None`
- `checkpoint_clmm(self, ts_ns: typing.SupportsInt | typing.SupportsIndex, sqrt_price: int, liquidity: int, ticks: list = []) -> None`
- `descriptor_clmm(self, venue: typing.SupportsInt | typing.SupportsIndex, fee_pips: typing.SupportsInt | typing.SupportsIndex, base_dec: typing.SupportsInt | typing.SupportsIndex, quote_dec: typing.SupportsInt | typing.SupportsIndex) -> None`
- `descriptor_constant_product(self, fee_num: typing.SupportsInt | typing.SupportsIndex, fee_den: typing.SupportsInt | typing.SupportsIndex, base_dec: typing.SupportsInt | typing.SupportsIndex, quote_dec: typing.SupportsInt | typing.SupportsIndex) -> None`
- `descriptor_raydium_cp(self, trade_fee_rate: typing.SupportsInt | typing.SupportsIndex, creator_fee_rate: typing.SupportsInt | typing.SupportsIndex, creator_fee_on_input: bool, base_dec: typing.SupportsInt | typing.SupportsIndex, quote_dec: typing.SupportsInt | typing.SupportsIndex) -> None`
- `replay(self, base_idx: typing.SupportsInt | typing.SupportsIndex = 0, quote_idx: typing.SupportsInt | typing.SupportsIndex = 1, base_dec: typing.SupportsInt | typing.SupportsIndex = 18, quote_dec: typing.SupportsInt | typing.SupportsIndex = 18) -> PoolReplay`
- `swap(self, ts_ns: typing.SupportsInt | typing.SupportsIndex, base_for_quote: bool, amount_in: int) -> None`
