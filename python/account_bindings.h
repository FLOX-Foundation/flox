...
inline void bindAccount(py::module_& m)
{
  ...
  py::class_<flox::Account>(m, "Account")
      ...
      .def("open_position", &flox::Account::openPosition, py::arg("symbol"), py::arg("quantity"), py::arg("entry_price"), py::arg("isolated_equity") = 0.0, py::arg("contract_multiplier") = 1.0, py::arg("is_long_option") = false)
      ...
      .def("margin_notional", &flox::Account::marginNotional)
      .def("margin_unrealised_pnl", &flox::Account::marginUnrealisedPnl)
      .def("cross_headroom", &flox::Account::crossHeadroom, py::arg("tier_fraction"))
