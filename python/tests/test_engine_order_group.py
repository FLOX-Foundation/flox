"""Tests for the C++-engine-backed OrderGroup state machine (W15-T004).

The legacy Python helper lives in `flox_py.execution.OrderGroup`. This
suite exercises the new `flox_py.OrderGroup` (bound from
`include/flox/execution/order_group.h`), which the NAPI / QuickJS /
