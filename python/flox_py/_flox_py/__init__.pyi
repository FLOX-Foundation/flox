...
class Account:
    ...
    def mark_ts_for(self, symbol: typing.SupportsInt | typing.SupportsIndex) -> int:
        ...
    def open_position(self, symbol: typing.SupportsInt | typing.SupportsIndex, quantity: typing.SupportsFloat | typing.SupportsIndex, entry_price: typing.SupportsFloat | typing.SupportsIndex, isolated_equity: typing.SupportsFloat | typing.SupportsIndex = 0.0) -> None:
        ...
